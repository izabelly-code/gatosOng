...
public class DonationController {
    ...
    public ResponseEntity<?> getDonations() {
        try {
            ...
            List<DonationModel> donationModelList = getDonationService().getAllDonations();
    ...
    public ResponseEntity<?> getDonationById(@PathVariable Long id) {
        try {
            ...
            List<DonationModel> donationModelList = getDonationService().getDonationById(id);
    ...
    public ResponseEntity<?> createDonation(@RequestBody DonationModel donationModel) {
        try {
            ...
            List<DonationModel> donationModelList = getDonationService().createDonation(donationModel);
